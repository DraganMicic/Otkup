...
public class POSPrintUlaz {
	...
	public void stampajUlazNaPOS(UnosUlaza uu) {
	    ...
	    Label gajba0 = new Label("List gajbi br. __");
	    if(uu.getUnosGajbi() != null) {
	    	gajba0 = new Label("List gajbi br. " + String.valueOf(uu.getUnosGajbi().getSifra()));
	    }
	   
	    Label gajbe2 = new Label("Ulaz/izlaz: " + String.valueOf(gajbeUlaz) + "/" + String.valueOf(gajbeIzlaz));
	    Label gajbe1 = new Label("Gajbe: ");
	    ...
	    Label prosek = new Label("Prosečna težina u gajbi: " +  numberFormat2.format(p));
	    Label ukupnoZaduzenih = new Label("Ukupno zaduženih gajbi: " + String.valueOf(Firma.getInstance().getTrenutnaGodina().gajbiKodProizvodjaca(uu.getProizvodjac())));  
