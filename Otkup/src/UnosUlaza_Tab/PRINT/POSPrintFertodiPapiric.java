...
public class POSPrintFertodiPapiric {

private static POSPrintFertodiPapiric instance;
	
	public static POSPrintFertodiPapiric getInstance() {
		if(instance == null) {
			instance = new POSPrintFertodiPapiric();
		}
		return instance;
	}
